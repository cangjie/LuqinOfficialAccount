	...
	$( document ).ready(function() {
		function c(passed_month, passed_year, calNum) {
			...
			clickedElement.on("click", function(){
				...
				console.log('click', whichCalendar);
				...
				if (!firstClick) {
					...
					var secondClickDateObj = new Date(secondClicked.year, 
												secondClicked.month, 
												secondClicked.date);
                    //firstClickDateObj = secondClickDateObj;
					...
					//selected = addChosenDates(firstClicked, secondClicked, selected);
                    //selected = addChosenDates(secondClicked, secondClicked, selected);
                    bothCals.find(".calendar_content").find("div").each(function(){
                        $(this).removeClass("selected");
                    });
                    selected[secondClicked.year] = {};
                    selected[secondClicked.year][secondClicked.month] = [secondClicked.date];
				}
