var apiDescriptionList = [
    ...
    },
    {
        'name': '反包后，大阴线下跌',
        'description': '📉表示跌停',
        'url': '/api/Reverse/OpenHighWithHugeGreen',
        'defaultCountDays': 15,
        'defaultSort': '代码 desc'
    },
    {
    ...
    {
        'name': '放量资金持续流入',
        'description': '📈：大单流入比例大于10%，且大单流入大于总流入；🔥：连续两天大单流入大于10%，且大单流入大于总流入。',
    ...
    {
        'name': '涨停后缩量',
        'description': '🌟：高开未涨停；3⃣️：三天内碰三线；🔺：次5日高开过前高；🟢：跌破F3；☠️：跌破F5；🐴：马头；🆙：涨停；🚩：连板；💩：触及跌停；❤️：最低触及F3；🖤：最低触及F5；☢️：调整不碰DMP',
        'url': '/api/OldModel/VolumeReduce',
        'defaultCountDays': 15,
        'defaultSort': '代码 desc'
    },
    {
        'name': '涨停后缩量',
        'description': '🌟：创新高；3⃣️：三天内碰三线；🔺：次5日高开过前高；🟢：跌破F3；☠️：跌破F5；🐴：马头；🆙：涨停；🚩：连板；💩：触及跌停；❤️：最低触及F3；🖤：最低触及F5；☢️：调整不碰DMP',
    ...
    {
        'name': '放量资金持续流入精选',
        'description': '如果大单流入低于10%，当天选出来的股票不足两个，则补齐。📈：大单流入比例大于10%，且大单流入大于总流入；🔥：连续两天大单流入大于10%，且大单流入大于总流入；🌞：大单流入超过10%',
